        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-fff">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-inside-box ng-fault ng-container" aos="fade-up">
                    <div class="dataStyle">
                        <figure v-for="(item,index) in dataList" v-bind:key="index" class="effect-bubba">
                            ...
                            <figcaption>
                                <h2><span>{{item.shangpinName}}</span></h2>
                                <p v-if="item.shangpinNewMoney != null" >￥{{item.shangpinNewMoney}}</p>
                                <a @click="jumpCheck('../shangpin/detail.jsp?id='+item.shangpinId , item.shangpinDelete == null?'':item.shangpinDelete , item.shangxiaTypes == null?'':item.shangxiaTypes)" >View more</a>
                            </figcaption>
                        </figure>
                    </div>
                    <nav class="pages">
