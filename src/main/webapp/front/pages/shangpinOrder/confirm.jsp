    ...
    <!-- 标题 -->
            ...
            <div class="common_list_con clearfix">
                ...
                <ul class="goods_list_td clearfix"  v-for="(item,index) in dataList" v-bind:key="index">
                    ...
                    <li class="col02"><img :src="item.shangpinPhoto"></li><!-- style="width: 100px;height: 100px;object-fit: cover;"-->
                    <li class="col03">{{item.shangpinName}}</li>
                    <li class="col05">{{item.shangpinNewMoney}} RMB</li>
                    <li class="col06">{{item.buyNumber}}</li>
					<li class="col07">{{(item.shangpinNewMoney*item.buyNumber).toFixed(2)}} RMB</li>
                </ul>
            </div>

			<h3 class="common_title">结算</h3>
			<div class="common_list_con clearfix">
				<div class="settle_con" v-if="this.shangpinOrderPaymentTypes == 1">
				...
				<div class="settle_con" v-if="this.shangpinOrderPaymentTypes == 2">
